...
isort:skip_file
Vendored locally from open-telemetry/opentelemetry-proto#783, which adds the
`ProcessContext` message from OTEP 4719 (merged 2026-04-07). Once that PR
lands and a release is cut, this file should be removed and the generated
bindings should come from the upstream `scripts/proto_codegen.sh` flow.

Source: https://github.com/open-telemetry/opentelemetry-proto/pull/783
"""
import builtins
